...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=nmABwQwI#5LDVdPmquDBYF2N8SM7Ad3RACx-r8dDDCrgyXkD0aZs' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94702572157,94716682532' : process.env.SUDO,
...
AUTO_STICKER: process.env.AUTO_STICKER === undefined ? "falsee" : process.env.AUTO_STICKER,
